...
exports.split = function (){
    ...
    var copy = new objs.Cell(cell.x,cell.y,cell.r, cellenergy,cell.name,cell.color,cell.number,cell.comment,cell.code,env.newId());
